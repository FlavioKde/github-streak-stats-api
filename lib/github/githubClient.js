...
import { mapGitHubContributionsRaw, mapGitHubLanguages, mapGitHubActivity } from "./githubMapper.js";
...
async function fetchSingleRange(username, fromDate, toDate) {
  ...
  try {
    ...
    return mapGitHubContributionsRaw(userData);
  }
...
console.log('ALL DAYS LENGTH:', allDays.length);
 ...
 console.log('MERGED DAYS LENGTH:', mergedDays.length);
  console.log('LAST DAYS:', mergedDays.slice(-10));
  return mergedDays;
